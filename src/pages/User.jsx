        ...
        <div>
            <div className=" bg-white shadow-lg rounded-lg overflow-hidden my-4">
                ...
                <div className="flex items-center px-6 py-3 bg-gray-900">
                    ...
                    <h1 className="mx-3 text-white font-semibold text-lg">{available ? 'Available' : 'Not available'}</h1>
                </div>
                <div className="py-4 px-6">
                    <h1 className="text-2xl font-semibold text-gray-800">{firstName} {lastName}</h1>
                    {/* <p className="py-2 text-lg text-gray-700">Full Stack maker & UI / UX Designer.</p> */}
                    <div className="flex items-center mt-4 text-gray-700">
                        ...
                        <h1 className="px-2 text-sm">{gender}</h1>
                    </div>
                    <div className="flex items-center mt-4 text-gray-700">
                        <svg className="h-6 w-6 fill-current" viewBox="0 0 512 512">
                            <path d="M256 32c-88.004 0-160 70.557-160 156.801C96 306.4 256 480 256 480s160-173.6 160-291.199C416 102.557 344.004 32 256 32zm0 212.801c-31.996 0-57.144-24.645-57.144-56 0-31.357 25.147-56 57.144-56s57.144 24.643 57.144 56c0 31.355-25.148 56-57.144 56z" />
                        </svg>
                        <h1 className="px-2 text-sm">{domain}</h1>
                    </div>
                    <div className="flex items-center mt-4 text-gray-700">
                        <svg className="h-6 w-6 fill-current" viewBox="0 0 512 512">
